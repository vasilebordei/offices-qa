...
//     await driver.findElement(By.id("remote-button")).click();
//     //adds a percentage for the hybrid work model
//     let percetageValue = await driver
//       .findElement(by.id("percentage"))
//       .getAttribute("value");
//     //verifies if percentage value is 100%
//     percetageValue.should.equal("100%");
